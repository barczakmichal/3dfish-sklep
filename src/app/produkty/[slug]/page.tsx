...
import { getProductBySlug, getProductsByCategory, getCategory } from "@/data/products";
  ...
  if (!product) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-20 text-center">
        ...
        <p className="text-slate-500 mb-6">Nie udało się znaleźć tego produktu.</p>
        <Link href="/produkty" className="text-emerald-600 font-medium hover:underline">
          Wróć do produktów
        </Link>
      </div>
    );
